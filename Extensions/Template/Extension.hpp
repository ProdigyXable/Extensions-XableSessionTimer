...
public:
	...
	void UnPauseGameSession();
	void ActiveNthSession(unsigned int x);
	void SetNthSession(unsigned int x, int y);
	void SetGlobalSessiontoValue(int y);
	void DeleteSession(unsigned int x);
	void ToggleSession(unsigned int x);
	void ToggleGameSession();
	void AutomateOn();
	void AutomateOff();
	void AutomateToggle();
	void RefreshOn();
